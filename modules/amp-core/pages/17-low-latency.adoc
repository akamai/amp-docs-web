...
This tutorial shows how to setup Ultra low latency streaming in AMP.
...
* `liveSyncDuration`: Defines how far back in time the playback can be relative to the most recent segment of the live stream. 
