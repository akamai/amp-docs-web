...
For more information on how to use multiple sources, read {@tutorial 03-load-media}. When dealing with various sources, the keys for all sources should be provided in the keys object.
