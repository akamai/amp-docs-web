...
var config = {
  plugins: {
    conviva : {
      resources: [
        {src: "#{paths.plugins}amp-conviva/libs/amp-conviva-pages-sdk-2.121.0.32738.min.js", type: "text/javascript", async: true},
        {src: "#{paths.plugins}amp-conviva/libs/amp-conviva-html5native-impl.js", type: "text/javascript", async: true},
        {src: "#{paths.plugins}amp-conviva/Conviva.js", type: "text/javascript", async: true}
      ],
